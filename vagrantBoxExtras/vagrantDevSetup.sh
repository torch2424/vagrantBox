...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installApache.sh; break;;
        [Nn]* ) break;;
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installMysql.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installEclipse.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installNpm.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installRuby.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installPip.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/installScripts/installGo.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
...
while true; do
    ...
    read yn
    case $yn in
        [Yy]* ) /vagrant/vagrantBoxExtras/configFiles/personalPrefs.sh; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes (y) or no (n).";;
    esac
done
